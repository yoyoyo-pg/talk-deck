        ...
        <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto">
          {decks.map((deck) => (
            <button
              ...
              className="flex flex-col items-start p-4 rounded-2xl shadow-lg active:scale-95 transition-transform duration-150 text-left"
            ...
            >
              ...
              <span className="text-white/50 text-xs mt-2">{deck.cards.length}枚</span>
            </button>
          ))}
        </div>
      </main>
